"""detect_professional_malicious_user URL Configuration
...
from detect_professional_malicious_user import settings
...
urlpatterns = [
    ...
    url(r'^Predict_User_Type/$', remoteuser.Predict_User_Type, name="Predict_User_Type"),
    ...
    url(r'^View_User_Type_Ratio/$', serviceprovider.View_User_Type_Ratio, name="View_User_Type_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Prediction_Of_User_Type/$', serviceprovider.View_Prediction_Of_User_Type, name="View_Prediction_Of_User_Type"),
