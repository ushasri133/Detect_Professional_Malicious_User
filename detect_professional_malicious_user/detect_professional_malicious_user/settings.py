...
ROOT_URLCONF = 'detect_professional_malicious_user.urls'
...
WSGI_APPLICATION = 'detect_professional_malicious_user.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'detect_professional_malicious_user',
        'USER':'root',
        'PASSWORD': '',
        'HOST' :'127.0.0.1',
        'PORT' :'3306',
