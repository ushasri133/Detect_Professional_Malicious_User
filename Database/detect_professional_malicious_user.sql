...
--
-- Host: localhost
-- Generation Time: Sep 16, 2022 at 01:01 PM
...
--
-- Database: `detect_professional_malicious_user`
--
CREATE DATABASE IF NOT EXISTS `detect_professional_malicious_user` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `detect_professional_malicious_user`;
...
(1, 'Govind', 'Govind123@gmail.com', 'Govind', '9535866270', 'India', 'Karnataka', 'Bangalore', '#892,4th Cross,Rajajinagar', 'Male'),
...
(15, 'Naive Bayes', '62.22222222222222'),
(16, 'SVM', '65.71428571428571'),
(17, 'Logistic Regression', '63.17460317460317'),
(18, 'Decision Tree Classifier', '62.857142857142854'),
(19, 'Gradient Boosting Classifier', '60.317460317460316');
...
(17, 'Malicious User', '20.0'),
(18, 'Normal User', '80.0');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_malacious_user`
--

CREATE TABLE IF NOT EXISTS `remote_user_malacious_user` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `Gender` varchar(3000) NOT NULL,
  `Age` varchar(3000) NOT NULL,
  `title` varchar(3000) NOT NULL,
  `title_orig` varchar(3000) NOT NULL,
  `rating` varchar(3000) NOT NULL,
  `tags` varchar(3000) NOT NULL,
  `product_color` varchar(3000) NOT NULL,
  `countries_shipped_to` varchar(3000) NOT NULL,
  `product_url` varchar(3000) NOT NULL,
  `product_id` varchar(3000) NOT NULL,
  `Prediction` varchar(300) NOT NULL,
  `units_sold` varchar(300) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=7 ;

--
-- Dumping data for table `remote_user_malacious_user`
--

INSERT INTO `remote_user_malacious_user` (`id`, `Gender`, `Age`, `title`, `title_orig`, `rating`, `tags`, `product_color`, `countries_shipped_to`, `product_url`, `product_id`, `Prediction`, `units_sold`) VALUES
(1, 'M', '30', 'Femmes Mode Ã‰tÃ© LÃ¢che Sans Manches Poches Couleur Unie Maxi Dress Robe DÃ©contractÃ©e Plus La Taille', 'Women''s Fashion Summer Loose Sleeveless Pockets Solid Color Maxi Dress Casual Dress Plus Size', '3.46', 'Summer,Plus Size,long dress,plus size dress,Dress,Women''s Fashion,maxi dress,Casual,beach dress,Sleeveless dress,summer dresses,women dress,Fashion,loose dress,sleeveless', 'grey', '25', 'https://www.wish.com/c/5cac5af68de7960d89e54fe0', '5cac5af68de7960d89e54fe0', 'Normal User', '1000'),
(3, 'M', '34', '2018 New Fashion Women''s Tops Sexy Strappy Sleeveless Dentelle sans manches Crop Cops', '2018 New Fashion Women''s Tops Sexy Strappy Sleeveless Lace Crop Tops', '3.83', 'blouse,Plus Size,Lace,lace top,Tops,Fashion,strappy,sexy,sleeveless,summer tops,Women Fashion', 'white', '41', 'https://www.wish.com/c/5b07a7c6e997b33c6f9947da', '5b07a7c6e997b33c6f9947da', 'Malicious User', '100000'),
(4, 'M', '31', 'Nouveau Femme Dentelle Crochet Bikini Maillot de bain Maillot de bain Maillot de bain Maillot de bain d''Ã©tÃ©', 'New Women Lace Crochet Bikini Cover Up Swimwear Bathing Suit Summer Swimwear', '4.03', 'Summer,midsleevebeachblouse,summerswimsuit,womensummerswimwear,crochet,Cover,womenbeachblouse,Swimsuit,Bikini,beachblouse,Swimwear,bikinibeachcoverup,Women,women fashion dress,women bathing suit,budsilkblouse,Suits,Women''s Fashion,Lace', 'white', '43', 'https://www.wish.com/c/5a4f2d8f5dcd0221008b2c36', '5a4f2d8f5dcd0221008b2c36', 'Normal User', '1000'),
(5, 'M', '33', '5 Couleur Femmes De Mode D''Ã©tÃ© Mince Sans Manches ImprimÃ© Camouflage Robe Taille Haute Ã€ Lacets Casual Poche Mini Robes Plus La Taille S-5XL', '5 Color Women''s Fashion Summer Slim Sleeveless Camouflage Print Dress High Waist Lace Up Casual Pocket Mini Dresses Plus Size S-5XL', '4.16', 'Summer,Plus Size,Lace,Mini,Dress,slim,camouflage,Mini dress,Pocket,high waist,Women''s Fashion,Fashion,Lace Up,t,print dress,Print,sleeveless,bodycon,Casual,Women Fashion,Waist', 'pink', '41', 'https://www.wish.com/c/5d2fd5a9af7a0c5b21369a05', '5d2fd5a9af7a0c5b21369a05', 'Normal User', '1000'),
(6, 'M', '36', 'Nouveau Mode Femmes Lettre Imprimer Tie Dye Halter Sans Manches Longue Robe D''Ã©tÃ© Coton BohÃ¨me Maxi Boho Robe', 'New Women''s Fashion Letter Print Tie Dye Halter Sleeveless Long Dress Summer Cotton Bohemian Maxi Boho Dress', '4.11', 'Summer,Plus Size,Halter,letter print,long dress,Dyes,Dress,Women''s Fashion,maxi dress,boho,Fashion,boho dress,Tie Dye,sleeveless,Print,bohemian dress,bohemian,Women Fashion,Cotton', 'pink', '43', 'https://www.wish.com/c/5d2432e4e991b724c8327597', '5d2432e4e991b724c8327597', 'Normal User', '5000');
